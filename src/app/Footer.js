          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a
                ...
                className="text-gray-400 hover:text-orange-600 duration-300 dark:hover:text-white mx-2"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
